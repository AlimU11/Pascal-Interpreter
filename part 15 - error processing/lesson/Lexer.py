...
class Lexer(object):
    ...
    def number(self):
        ...
        if self.current_char == '.':
            ...
            token = Token(TokenType.INTEGER_CONST, int(result), self.lineno, self.column)
    ...
    def get_next_token(self) -> Token:
        ...
        return Token(type=TokenType.EOF, value=None, lineno=self.lineno, column=self.column)
